    ...
    <body>
        ...
        <section class="inner-banner">
            <div class="thm-container">
                ...
                <ul class="breadcumb">
                    <li><a href="about.php"><i class="fa fa-home"></i> About</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="sec-title">
                            ...
                            <p>Our capability to provide end-to-end turnkey solutions as well as our strategic location makes 
                                Davie the partner of choice for clients across a broad range of industries from offshore oil & gas to defense.</p>                        
                            <p></p>                        
                        </div>
                    </div>
                </div>
