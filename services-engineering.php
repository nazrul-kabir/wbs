        ...
        <section class="inner-banner">
            <div class="thm-container">
                ...
                <ul class="breadcumb">
                    ...
                    <li><span>GENERAL ENGINEERING</span></li>
                </ul>
            </div>
        </section>
                        ...
                        <div class="single-sidebar-widget">
                            <div class="special-links">
                                <ul>
                                    ...
                                    <li class="active"><a href="#">General Engineering</a></li>
                    ...
                    <div class="col-md-8">
                        <div class="tab-pane">
                            <div class="image-box clearfix">
                                <img src="images/services/Engineering/engg-2.jpg" alt="Awesome Image"/>
                                <img src="images/services/Engineering/engg-1.jpg" alt="Awesome Image" class="pull-right" />
                            </div>
                            <div class="sec-title">
