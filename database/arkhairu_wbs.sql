...
--
-- Host: localhost:3306
-- Generation Time: Mar 31, 2016 at 05:37 PM
...
(9, 'Client 7', 'http://www.kkrdf.com', 'PIMG_20160331151500.png', 'Active', 1, '2016-03-31 15:15:00', 0, '2016-03-31 09:15:00');
...
(2, 'Khairul Islam', 'arkhairul@hotmail.com', 'Demo', 'Demo', '2016-03-31 04:16:39');
...
(8, 'WATER BONDSHIPYARD WILL DELIVER SHIP TO NEW ZEALAND IN PRESENCE OF CANADIAN HIGH COMMISSIONER', 'NEIMG_20160330164548.jpg', '&lt;span style="color:#333333;font-family:Arial, Helvetica, sans-serif;line-height:22px;text-align:justify;"&gt;MV Mataliki, an Intl. SOLAS Passenger Ship that Waterbond Shipyard has built for New Zealand Ministry of Foreign Affairs and Trade (MFAT), will be handed over to her owner today 14 Dec 2016&lt;/span&gt;', 'Active', 1, '2016-03-30 16:45:48', 0, '2016-03-31 07:19:18'),
(9, 'SR. VICE PRESIDENT OF WORLD BANK PAYS VISIT TO WATERBOND SHIPYARD', 'NEIMG_20160330164646.jpg', '&lt;span style="color:#333333;font-family:Arial, Helvetica, sans-serif;line-height:22px;text-align:justify;"&gt;The Sr. Vice President (SVP) of the World Bank Mr. Kyle Peters has paid a goodwill visit to the country&amp;rsquo;s leading shipyard, Waterbond Shipyard Limited on the 29th of October 2015.&lt;/span&gt;', 'Active', 1, '2016-03-30 16:46:46', 0, '2016-03-31 07:16:05');
...
(1, 'AFTER SALES', 'SEIMG_20160331104658.jpg', 'To achieve success WSY is always committed to provide "After sales service"&lt;br /&gt;', 'Active', 1, '2016-03-31 02:06:52', 0, '2016-03-31 04:46:58'),
(2, 'GENERAL ENGINEERING', 'SEIMG_20160331104805.jpg', 'General Engineering in WBSY encompasses design and construction of roof trusses, chimney, staging girders, mooring buoys, light tower, trolleys, trailers, steel tanks&lt;br /&gt;', 'Active', 1, '2016-03-31 02:07:43', 0, '2016-03-31 04:48:05'),
(3, 'SHIP REPAIR', 'SEIMG_20160331105335.jpg', 'Repair and renovation are the most normal activities at this shipyard.', 'Active', 1, '2016-03-31 10:50:33', 0, '2016-03-31 04:53:35'),
(4, 'SHIP BUILDING', 'SEIMG_20160331105425.jpg', '&lt;p&gt;Shipbuilding department of WBSY is capable of new building and renovating ships of various types e.g. patrol craft, cargo, Launches, oil tankers etc.&lt;/p&gt;&lt;p&gt;&lt;/p&gt;', 'Active', 1, '2016-03-31 10:52:01', 0, '2016-03-31 04:55:33');
