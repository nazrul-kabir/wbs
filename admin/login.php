    ...
    <body class="login-page">
        <div class="login-box">
            <div class="login-logo">
                <a class="logo" href="#"><img style="width: 358px;margin-top: -3px; background-color: #367fa9; border: 5px solid #367fa9;border-radius: 3px;" class="img-responsive" src="assets/wbs-logo.png"></a>
            </div>
